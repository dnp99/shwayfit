import { CalendarCheck, CalendarDays, ChevronLeft, ChevronRight, Info, Plus } from 'lucide-react'
...
function TimeGrid({ appointments, clients, days, onSelectAppointment }: { appointments: Appointment[]; clients: Client[]; days: Date[]; onSelectAppointment: (appointment: Appointment) => void }) {
...
function BookingDialog({ appointments, clients, initialClientID, onBooked, onOpenChange, open }: { appointments: Appointment[]; clients: Client[]; initialClientID: string; onBooked: (appointment: Appointment) => void; onOpenChange: (open: boolean) => void; open: boolean }) {
