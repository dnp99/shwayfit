...
The client editor includes optional Starting measurements: height in centimetres and a dated starting weight in kilograms with brief context. The client detail page shows this baseline alongside contact details. Entering a starting weight also creates the client’s first dated measurement record, ready for a later measurement-history workflow.
